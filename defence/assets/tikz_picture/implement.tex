\begin{tikzpicture}
    ...
    \node(bamsoo)[class, below of = soo]{BaMSOO};
    ...
    \begin{scope}[on background layer]
        \node(optimization)[draw, thick,fill=black!10,opacity=0.5,on background layer, draw=black!70, dashed, rounded corners, fit=(algo)(bamsoo)(bo), inner sep=0.2cm, label=above:{Optimisation}] {};
    \end{scope}
    ...
    \begin{scope}[on background layer]
        \node(search_space)[draw, thick,fill=black!10,opacity=0.5,on background layer, draw=black!70, dashed, rounded corners, fit=(space)(solution)(var), inner sep=0.2cm, label=above:{Search Space}] {};
    \end{scope}
    ...
    \begin{scope}[on background layer]
        \node(search_space)[draw, thick,fill=black!10,opacity=0.5,on background layer, draw=black!70, dashed, rounded corners, fit=(evaluation), inner sep=0.2cm, label=below:{Evaluation}] {};
    \end{scope}
    ...
    % legend
    \node (legend)[below of = bamsoo, yshift = 0.1cm, xshift = -0.15cm]{Légende : };
