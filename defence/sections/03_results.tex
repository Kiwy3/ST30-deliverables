...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Résultats %%%%%%%%%%%%%%%%%%
\begin{frame}{Résultats des 3 algorithmes : BO, SOO et BaMSOO}
    \begin{columns}

        \begin{column}{0.45\textwidth}
            \begin{figure}
                \centering
                \input{assets/tikz_picture/global_results/hellaswag.tex}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                \centering
                \input{assets/tikz_picture/global_results/mmlu.tex}
