...
\newcommand{\titletext}{
    ...
    This internship took place at INRIA Lille, within the BONUS research team. The aims of this internship was to explore the applications of optimization algorithms to the current hot topic of Neural networks: \acrfull{llm}. In particular, I worked  more spec on \acrfull{hpo} applied to \acrshort{llm} fine-tuning. The work was split in three stages: 
    \begin{itemize}
