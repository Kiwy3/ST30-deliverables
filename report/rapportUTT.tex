...
\newcommand{\titletext}{
    ...
    This internship took place at \acrshort{inria} Lille, within the \acrshort{bonus} research team. The aims of this internship was to explore the applications of optimization algorithms to the current hot topic of Neural networks: \gls{llm}. In particular, I worked  more specifically on \gls{hpo} applied to \gls{llm} \gls{ft}. The work was split in three stages: 
    \begin{itemize}
    \item Definition of the subject: explore the specific literature to understand stakes and how it works.
    \item Implementation of the algorithms: develop \gls{hpo} algorithms and use them for \gls{llm} \gls{ft}.
