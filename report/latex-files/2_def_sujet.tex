...
%%--------------------SECTION : LLM---------------------%%
\section{Large Langage Model (LLM)}
\label{sec:llm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Review LLM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Review and taxonomy of \glspl{llm}}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{.45\linewidth}
      \centering
      \input{assets/img/chap_2/plots/soo_partition.tex}
      \caption{SOO partition}
      \label{fig:pbo_partition}
    \end{subfigure}%
    \begin{subfigure}{.45\linewidth}
      \centering
      \input{assets/img/chap_2/plots/soo_tree.tex}
      \caption{SOO tree}
      \label{fig:pbo_tree}
    \end{subfigure}
...
\subsection{\glspl{llm}-based supply chain management}
\label{sec:llm_scm}
